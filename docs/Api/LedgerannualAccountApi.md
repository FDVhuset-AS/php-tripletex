# Tripletex\LedgerannualAccountApi
...
# **get**
> \Tripletex\Model\ResponseWrapperAnnualAccount get($id, $fields)
...
$apiInstance = new Tripletex\Api\LedgerannualAccountApi(
...
[**\Tripletex\Model\ResponseWrapperAnnualAccount**](../Model/ResponseWrapperAnnualAccount.md)
...
# **search**
> \Tripletex\Model\ListResponseAnnualAccount search($id, $year_from, $year_to, $from, $count, $sorting, $fields)
...
[**\Tripletex\Model\ListResponseAnnualAccount**](../Model/ListResponseAnnualAccount.md)
