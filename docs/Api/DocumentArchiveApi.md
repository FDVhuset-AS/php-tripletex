...
[**\Tripletex\Model\ListResponseDocumentArchive**](../Model/ListResponseDocumentArchive.md)
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| Element ID |
 **body** | [**\Tripletex\Model\DocumentArchive**](../Model/DocumentArchive.md)| Partial object describing what should be updated | [optional]
