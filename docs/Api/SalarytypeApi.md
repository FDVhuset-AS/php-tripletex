...
# **get**
> \Tripletex\Model\ResponseWrapperSalaryType get($id, $fields)
...
$apiInstance = new Tripletex\Api\SalarytypeApi(
...
[**\Tripletex\Model\ResponseWrapperSalaryType**](../Model/ResponseWrapperSalaryType.md)
...
# **search**
> \Tripletex\Model\ListResponseSalaryType search($id, $number, $name, $description, $from, $count, $sorting, $fields)
...
try {
    $result = $apiInstance->search($id, $number, $name, $description, $from, $count, $sorting, $fields);
    print_r($result);
} catch (Exception $e) {
...
[**\Tripletex\Model\ListResponseSalaryType**](../Model/ListResponseSalaryType.md)
