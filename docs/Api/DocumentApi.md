...
$apiInstance = new Tripletex\Api\DocumentApi(
...
# **get**
> \Tripletex\Model\ResponseWrapperDocument get($id, $fields)
...
[**\Tripletex\Model\ResponseWrapperDocument**](../Model/ResponseWrapperDocument.md)
