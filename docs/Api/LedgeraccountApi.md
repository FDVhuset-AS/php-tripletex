...
# **search**
> \Tripletex\Model\ListResponseAccount search($id, $number, $is_bank_account, $is_inactive, $is_applicable_for_supplier_invoice, $from, $count, $sorting, $fields)
...
try {
    $result = $apiInstance->search($id, $number, $is_bank_account, $is_inactive, $is_applicable_for_supplier_invoice, $from, $count, $sorting, $fields);
    print_r($result);
} catch (Exception $e) {
