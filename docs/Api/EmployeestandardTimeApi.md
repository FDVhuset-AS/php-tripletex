# Tripletex\EmployeestandardTimeApi
...
[**\Tripletex\Model\ResponseWrapperStandardTime**](../Model/ResponseWrapperStandardTime.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Tripletex\Model\StandardTime**](../Model/StandardTime.md)| JSON representing the new object to be created. Should not have ID and version set. | [optional]
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| Element ID |
 **body** | [**\Tripletex\Model\StandardTime**](../Model/StandardTime.md)| Partial object describing what should be updated | [optional]
...
[**\Tripletex\Model\ListResponseStandardTime**](../Model/ListResponseStandardTime.md)
