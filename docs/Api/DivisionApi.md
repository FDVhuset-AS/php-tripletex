...
------------- | ------------- | ------------- | -------------
 **body** | [**\Tripletex\Model\Division**](../Model/Division.md)| JSON representing the new object to be created. Should not have ID and version set. | [optional]

### Return type

[**\Tripletex\Model\ResponseWrapperDivision**](../Model/ResponseWrapperDivision.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Tripletex\Model\Division[]**](../Model/Division.md)| JSON representing a list of new object to be created. Should not have ID and version set. | [optional]

### Return type

[**\Tripletex\Model\ListResponseDivision**](../Model/ListResponseDivision.md)
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| Element ID |
 **body** | [**\Tripletex\Model\Division**](../Model/Division.md)| Partial object describing what should be updated | [optional]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Tripletex\Model\Division[]**](../Model/Division.md)| JSON representing updates to object. Should have ID and version set. | [optional]
