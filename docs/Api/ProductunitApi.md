...
# **get**
> \Tripletex\Model\ResponseWrapperProductUnit get($id, $fields)
...
$apiInstance = new Tripletex\Api\ProductunitApi(
...
[**\Tripletex\Model\ResponseWrapperProductUnit**](../Model/ResponseWrapperProductUnit.md)
...
# **search**
> \Tripletex\Model\ListResponseProductUnit search($id, $name, $name_short, $common_code, $from, $count, $sorting, $fields)
...
[**\Tripletex\Model\ListResponseProductUnit**](../Model/ListResponseProductUnit.md)
