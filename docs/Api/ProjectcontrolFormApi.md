# Tripletex\ProjectcontrolFormApi
...
# **get**
> \Tripletex\Model\ResponseWrapperProjectControlForm get($id, $fields)
...
$apiInstance = new Tripletex\Api\ProjectcontrolFormApi(
...
[**\Tripletex\Model\ResponseWrapperProjectControlForm**](../Model/ResponseWrapperProjectControlForm.md)
...
# **search**
> \Tripletex\Model\ListResponseProjectControlForm search($project_id, $from, $count, $sorting, $fields)
...
[**\Tripletex\Model\ListResponseProjectControlForm**](../Model/ListResponseProjectControlForm.md)
