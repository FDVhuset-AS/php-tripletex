...
[**\Tripletex\Model\ResponseWrapperProjectOrderLine**](../Model/ResponseWrapperProjectOrderLine.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Tripletex\Model\ProjectOrderLine**](../Model/ProjectOrderLine.md)| JSON representing the new object to be created. Should not have ID and version set. | [optional]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Tripletex\Model\ProjectOrderLine[]**](../Model/ProjectOrderLine.md)| JSON representing a list of new object to be created. Should not have ID and version set. | [optional]

### Return type

[**\Tripletex\Model\ListResponseProjectOrderLine**](../Model/ListResponseProjectOrderLine.md)
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| Element ID |
 **body** | [**\Tripletex\Model\ProjectOrderLine**](../Model/ProjectOrderLine.md)| Partial object describing what should be updated | [optional]
...
# **search**
> \Tripletex\Model\ListResponseProjectOrderLine search($project_id, $from, $count, $sorting, $fields)
