...
'payslips' => '\Tripletex\Model\Payslip[]'    ];
...
'payslips' => 'getPayslips'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_historical'] = isset($data['is_historical']) ? $data['is_historical'] : false;
     ...
     * Sets payslips
     *
     * @param \Tripletex\Model\Payslip[] $payslips Link to individual payslip objects.
     *
     * @return $this
     */
