...
/**
 * TripletexAccount2 Class Doc Comment
 *
 * @category Class
 * @package  Tripletex
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TripletexAccount2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TripletexAccount2';
...
'account_type' => 'string',
'modules' => '\Tripletex\Model\SalesModuleDTO[]',
...
self::CHART_OF_ACCOUNTS_TYPE_AGRO_FORENING_PAYROLL,        ];
     ...
     * Sets company
     *
     * @param \Tripletex\Model\Company $company company
     *
     * @return $this
     */
     ...
     * Gets modules
     *
     * @return \Tripletex\Model\SalesModuleDTO[]
     */
     ...
     * Sets modules
     *
     * @param \Tripletex\Model\SalesModuleDTO[] $modules Sales modules (functionality in the application) to activate for the newly created account. Some modules have extra costs.
     *
     * @return $this
     */
