...
self::OVERNIGHT_ACCOMMODATION_BOARDING_HOUSE_WITH_COOKING,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_deduction_for_breakfast'] = isset($data['is_deduction_for_breakfast']) ? $data['is_deduction_for_breakfast'] : false;
        $this->container['is_deduction_for_lunch'] = isset($data['is_deduction_for_lunch']) ? $data['is_deduction_for_lunch'] : false;
        $this->container['is_deduction_for_dinner'] = isset($data['is_deduction_for_dinner']) ? $data['is_deduction_for_dinner'] : false;
    }
