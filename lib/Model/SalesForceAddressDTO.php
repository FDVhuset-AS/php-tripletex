...
/**
 * SalesForceAddressDTO Class Doc Comment
 *
 * @category Class
 * @package  Tripletex
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SalesForceAddressDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SalesForceAddressDTO';
...
'postal_code' => 'string',
'city' => 'string',
'country' => '\Tripletex\Model\SalesForceCountryDTO'    ];
...
'country' => 'getCountry'    ];
     ...
     * Gets country
     *
     * @return \Tripletex\Model\SalesForceCountryDTO
     */
     ...
     * Sets country
     *
     * @param \Tripletex\Model\SalesForceCountryDTO $country country
     *
     * @return $this
     */
