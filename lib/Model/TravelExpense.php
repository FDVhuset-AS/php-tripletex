...
self::STATE_DELIVERED,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_salary_admin'] = isset($data['is_salary_admin']) ? $data['is_salary_admin'] : false;
        $this->container['show_payslip'] = isset($data['show_payslip']) ? $data['show_payslip'] : false;
        $this->container['accounting_period_closed'] = isset($data['accounting_period_closed']) ? $data['accounting_period_closed'] : false;
        $this->container['accounting_period_vat_closed'] = isset($data['accounting_period_vat_closed']) ? $data['accounting_period_vat_closed'] : false;
    }
     ...
     * Sets attachment
     *
     * @param \Tripletex\Model\Document $attachment attachment
     *
     * @return $this
     */
