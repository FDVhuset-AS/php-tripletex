...
'accounting_period' => '\Tripletex\Model\AccountingPeriod',
...
'closed_date' => 'string',
'closed_by_contact' => '\Tripletex\Model\Contact',
'closed_by_employee' => '\Tripletex\Model\Employee',
'approvable' => 'bool'    ];
...
self::TYPE_AUTOMATIC,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['approvable'] = isset($data['approvable']) ? $data['approvable'] : false;
    }
     ...
     *
     * @return \Tripletex\Model\AccountingPeriod
     */
     ...
     *
     * @param \Tripletex\Model\AccountingPeriod $accounting_period accounting_period
     *
     * @return $this
     */
     ...
     * Sets transactions
     *
     * @param \Tripletex\Model\BankTransaction[] $transactions Bank transactions tied to the bank reconciliation
     *
     * @return $this
     */
     ...
     *
     * @param \Tripletex\Model\Contact $closed_by_contact closed_by_contact
     *
     * @return $this
     */
     ...
     *
     * @param \Tripletex\Model\Employee $closed_by_employee closed_by_employee
     *
     * @return $this
     */
