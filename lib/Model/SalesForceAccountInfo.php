...
'end_date' => 'getEndDate'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_reseller'] = isset($data['is_reseller']) ? $data['is_reseller'] : false;
        $this->container['is_accountant'] = isset($data['is_accountant']) ? $data['is_accountant'] : false;
        $this->container['is_auditor'] = isset($data['is_auditor']) ? $data['is_auditor'] : false;
        $this->container['is_suspended'] = isset($data['is_suspended']) ? $data['is_suspended'] : false;
