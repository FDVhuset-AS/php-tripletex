...
'wildcard_subtype' => 'getWildcardSubtype'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['wildcard_type'] = isset($data['wildcard_type']) ? $data['wildcard_type'] : false;
        $this->container['wildcard_subtype'] = isset($data['wildcard_subtype']) ? $data['wildcard_subtype'] : false;
    }
