...
'timesheet_completed' => 'getTimesheetCompleted'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['time_clock'] = isset($data['time_clock']) ? $data['time_clock'] : false;
        $this->container['timesheet_completed'] = isset($data['timesheet_completed']) ? $data['timesheet_completed'] : false;
    }
