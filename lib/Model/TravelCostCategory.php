...
'is_inactive' => 'getIsInactive'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_vat_locked'] = isset($data['is_vat_locked']) ? $data['is_vat_locked'] : false;
        $this->container['show_on_travel_expenses'] = isset($data['show_on_travel_expenses']) ? $data['show_on_travel_expenses'] : false;
        $this->container['show_on_employee_expenses'] = isset($data['show_on_employee_expenses']) ? $data['show_on_employee_expenses'] : false;
