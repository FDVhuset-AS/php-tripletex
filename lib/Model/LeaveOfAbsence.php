...
'leave_of_absence_id' => 'setLeaveOfAbsenceId',
...
'leave_of_absence_id' => 'getLeaveOfAbsenceId',
...
self::TYPE_COMPASSIONATE,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['leave_of_absence_id'] = isset($data['leave_of_absence_id']) ? $data['leave_of_absence_id'] : null;
        $this->container['start_date'] = isset($data['start_date']) ? $data['start_date'] : null;
        $this->container['end_date'] = isset($data['end_date']) ? $data['end_date'] : null;
        $this->container['percentage'] = isset($data['percentage']) ? $data['percentage'] : null;
        $this->container['is_wage_deduction'] = isset($data['is_wage_deduction']) ? $data['is_wage_deduction'] : false;
    ...
    /**
     * Gets leave_of_absence_id
     *
     * @return string
     */
    public function getLeaveOfAbsenceId()
    {
        return $this->container['leave_of_absence_id'];
    }

    /**
     * Sets leave_of_absence_id
     *
     * @param string $leave_of_absence_id Existing leave of absence ID used by the current accounting system
     *
     * @return $this
     */
    public function setLeaveOfAbsenceId($leave_of_absence_id)
    {
        $this->container['leave_of_absence_id'] = $leave_of_absence_id;
