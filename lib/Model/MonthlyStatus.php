...
'date' => 'string',
'hours_paid' => 'double',
'vacation_transferred' => 'double',
'vacation_paid' => 'double',
'wage_payment' => '\Tripletex\Model\Payslip',
'completed' => 'bool',
'approved' => 'bool',
...
'date' => 'setDate',
'hours_paid' => 'setHoursPaid',
'vacation_transferred' => 'setVacationTransferred',
'vacation_paid' => 'setVacationPaid',
...
'date' => 'getDate',
'hours_paid' => 'getHoursPaid',
'vacation_transferred' => 'getVacationTransferred',
'vacation_paid' => 'getVacationPaid',
...
'approved_date' => 'getApprovedDate'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['hours_paid'] = isset($data['hours_paid']) ? $data['hours_paid'] : null;
        $this->container['vacation_transferred'] = isset($data['vacation_transferred']) ? $data['vacation_transferred'] : null;
        $this->container['vacation_paid'] = isset($data['vacation_paid']) ? $data['vacation_paid'] : null;
        ...
        $this->container['approved'] = isset($data['approved']) ? $data['approved'] : false;
     ...
     * @return double
     */
    public function getHoursPaid()
    {
        return $this->container['hours_paid'];
    }

    /**
     * Sets hours_paid
     *
     * @param double $hours_paid hours_paid
     *
     * @return $this
     */
    public function setHoursPaid($hours_paid)
    {
        $this->container['hours_paid'] = $hours_paid;

        return $this;
    }

    /**
     * Gets vacation_transferred
     *
     * @return double
     */
    public function getVacationTransferred()
    {
        return $this->container['vacation_transferred'];
    }

    /**
     * Sets vacation_transferred
     *
     * @param double $vacation_transferred vacation_transferred
     *
     * @return $this
     */
    public function setVacationTransferred($vacation_transferred)
    {
        $this->container['vacation_transferred'] = $vacation_transferred;
     ...
     * @return double
     */
    public function getVacationPaid()
    {
        return $this->container['vacation_paid'];
    }

    /**
     * Sets vacation_paid
     *
     * @param double $vacation_paid vacation_paid
     *
     * @return $this
     */
    public function setVacationPaid($vacation_paid)
    {
        $this->container['vacation_paid'] = $vacation_paid;
     ...
     * Sets wage_payment
     *
     * @param \Tripletex\Model\Payslip $wage_payment wage_payment
     *
     * @return $this
     */
