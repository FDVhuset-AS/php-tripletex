...
'timestamp' => '\DateTime',
'change_type' => 'string',
'period_reopened' => 'string',
'period_locked' => 'string'    ];
...
'period_reopened' => 'periodReopened',
...
'period_reopened' => 'setPeriodReopened',
'period_locked' => 'setPeriodLocked'    ];
...
'period_reopened' => 'getPeriodReopened',
'period_locked' => 'getPeriodLocked'    ];
...
self::CHANGE_TYPE_DO_NOT_SHOW,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['period_reopened'] = isset($data['period_reopened']) ? $data['period_reopened'] : null;
        $this->container['period_locked'] = isset($data['period_locked']) ? $data['period_locked'] : null;
    }
    ...
    /**
     * Gets period_reopened
     *
     * @return string
     */
    public function getPeriodReopened()
    {
        return $this->container['period_reopened'];
    }

    /**
     * Sets period_reopened
     *
     * @param string $period_reopened period_reopened
     *
     * @return $this
     */
    public function setPeriodReopened($period_reopened)
    {
        $this->container['period_reopened'] = $period_reopened;
     ...
     * @return string
     */
    public function getPeriodLocked()
    {
        return $this->container['period_locked'];
    }

    /**
     * Sets period_locked
     *
     * @param string $period_locked period_locked
     *
     * @return $this
     */
    public function setPeriodLocked($period_locked)
    {
        $this->container['period_locked'] = $period_locked;
