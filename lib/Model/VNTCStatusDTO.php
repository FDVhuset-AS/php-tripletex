...
/**
 * VNTCStatusDTO Class Doc Comment
 *
 * @category Class
 * @package  Tripletex
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VNTCStatusDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VNTCStatusDTO';
...
'external_sender_id' => 'setExternalSenderId',
...
'external_sender_id' => 'getExternalSenderId',
...
'operator' => 'getOperator'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['external_sender_id'] = isset($data['external_sender_id']) ? $data['external_sender_id'] : null;
        $this->container['external_message_id'] = isset($data['external_message_id']) ? $data['external_message_id'] : null;
        $this->container['part_count'] = isset($data['part_count']) ? $data['part_count'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['external_sender_id'] === null) {
            $invalidProperties[] = "'external_sender_id' can't be null";
        }
        if ($this->container['external_message_id'] === null) {
            $invalidProperties[] = "'external_message_id' can't be null";
        }
    ...
    /**
     * Gets external_sender_id
     *
     * @return string
     */
    public function getExternalSenderId()
    {
        return $this->container['external_sender_id'];
    }

    /**
     * Sets external_sender_id
     *
     * @param string $external_sender_id external_sender_id
     *
     * @return $this
     */
    public function setExternalSenderId($external_sender_id)
    {
        $this->container['external_sender_id'] = $external_sender_id;
     ...
     *
     * @param string $external_message_id external_message_id
     *
     * @return $this
     */
     ...
     * Sets part_count
     *
     * @param int $part_count part_count
     *
     * @return $this
     */
