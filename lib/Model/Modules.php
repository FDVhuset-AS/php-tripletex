...
'approve_voucher' => 'getApproveVoucher'    ];
    ...
    {
        $this->container['accounting'] = isset($data['accounting']) ? $data['accounting'] : false;
        $this->container['invoice'] = isset($data['invoice']) ? $data['invoice'] : false;
        $this->container['salary'] = isset($data['salary']) ? $data['salary'] : false;
        $this->container['salary_start_date'] = isset($data['salary_start_date']) ? $data['salary_start_date'] : null;
        $this->container['project'] = isset($data['project']) ? $data['project'] : false;
        $this->container['ocr'] = isset($data['ocr']) ? $data['ocr'] : false;
        $this->container['remit'] = isset($data['remit']) ? $data['remit'] : false;
        $this->container['electronic_vouchers'] = isset($data['electronic_vouchers']) ? $data['electronic_vouchers'] : false;
        $this->container['electro'] = isset($data['electro']) ? $data['electro'] : false;
        $this->container['vvs'] = isset($data['vvs']) ? $data['vvs'] : false;
        $this->container['agro'] = isset($data['agro']) ? $data['agro'] : false;
        $this->container['mamut'] = isset($data['mamut']) ? $data['mamut'] : false;
        $this->container['approve_voucher'] = isset($data['approve_voucher']) ? $data['approve_voucher'] : false;
    }
