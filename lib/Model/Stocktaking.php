...
self::TYPE_OF_STOCKTAKING_NO_PRODUCTS,        ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['type_of_stocktaking'] === null) {
            $invalidProperties[] = "'type_of_stocktaking' can't be null";
        }
     ...
     *
     * @param string $type_of_stocktaking Define the type of stoctaking.<br>ALL_PRODUCTS_WITH_INVENTORIES: Create a stocktaking for all products with inventories.<br>INCLUDE_PRODUCTS: Create a stocktaking which includes all products.<br>NO_PRODUCTS: Create a stocktaking without products.<br>If not specified, the value 'ALL_PRODUCTS_WITH_INVENTORIES' is used.
     *
     * @return $this
     */
