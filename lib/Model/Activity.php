...
self::ACTIVITY_TYPE_TASK,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_project_activity'] = isset($data['is_project_activity']) ? $data['is_project_activity'] : false;
        $this->container['is_general'] = isset($data['is_general']) ? $data['is_general'] : false;
        $this->container['is_task'] = isset($data['is_task']) ? $data['is_task'] : false;
