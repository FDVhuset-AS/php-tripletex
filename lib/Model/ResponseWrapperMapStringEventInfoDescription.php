...
class ResponseWrapperMapStringEventInfoDescription implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'value' => 'map[string,\Tripletex\Model\EventInfoDescription]'    ];
     ...
     * Gets value
     *
     * @return map[string,\Tripletex\Model\EventInfoDescription]
     */
     ...
     * Sets value
     *
     * @param map[string,\Tripletex\Model\EventInfoDescription] $value value
     *
     * @return $this
     */
