...
class BankreconciliationApi
{
     ...
     * @param  \Tripletex\Model\BankReconciliationAdjustment[] $body Adjustments (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseBankReconciliationAdjustment
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseBankReconciliationAdjustment, HTTP status code, HTTP response headers (array of strings)
     */
    public function adjustmentWithHttpInfo($id, $body = null)
    {
        $returnType = '\Tripletex\Model\ListResponseBankReconciliationAdjustment';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseBankReconciliationAdjustment',
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperBankReconciliation
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperBankReconciliation, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperBankReconciliation';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperBankReconciliation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Tripletex\Model\BankReconciliation $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperBankReconciliation
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\BankReconciliation $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperBankReconciliation
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseBankReconciliation
     */
    public function search($id = null, $accounting_period_id = null, $account_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseBankReconciliation, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $accounting_period_id = null, $account_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseBankReconciliation';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseBankReconciliation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $accounting_period_id = null, $account_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $accounting_period_id = null, $account_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseBankReconciliation';
        $request = $this->searchRequest($id, $accounting_period_id, $account_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $accounting_period_id = null, $account_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($accounting_period_id !== null) {
            $queryParams['accountingPeriodId'] = ObjectSerializer::toQueryValue($accounting_period_id);
        }
        // query params
        if ($account_id !== null) {
            $queryParams['accountId'] = ObjectSerializer::toQueryValue($account_id);
