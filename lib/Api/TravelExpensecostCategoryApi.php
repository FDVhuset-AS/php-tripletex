...
class TravelExpensecostCategoryApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperTravelCostCategory
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperTravelCostCategory, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperTravelCostCategory';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperTravelCostCategory',
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseTravelCostCategory
     */
    public function search($id = null, $description = null, $is_inactive = null, $show_on_employee_expenses = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseTravelCostCategory, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $description = null, $is_inactive = null, $show_on_employee_expenses = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseTravelCostCategory';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseTravelCostCategory',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $description = null, $is_inactive = null, $show_on_employee_expenses = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $description = null, $is_inactive = null, $show_on_employee_expenses = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseTravelCostCategory';
        $request = $this->searchRequest($id, $description, $is_inactive, $show_on_employee_expenses, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $description = null, $is_inactive = null, $show_on_employee_expenses = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($show_on_employee_expenses !== null) {
            $queryParams['showOnEmployeeExpenses'] = ObjectSerializer::toQueryValue($show_on_employee_expenses);
        }
        // query params
        if ($from !== null) {
