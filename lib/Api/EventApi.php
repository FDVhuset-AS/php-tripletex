...
class EventApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperEventInfoDTO
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperEventInfoDTO, HTTP status code, HTTP response headers (array of strings)
     */
    public function exampleWithHttpInfo($event_type, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperEventInfoDTO';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperEventInfoDTO',
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperMapStringEventInfoDescription
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperMapStringEventInfoDescription, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperMapStringEventInfoDescription';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperMapStringEventInfoDescription',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
