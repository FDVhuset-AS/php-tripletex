...
class SalarycompilationApi
{
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperSalaryCompilation
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperSalaryCompilation, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($employee_id, $year = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperSalaryCompilation';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperSalaryCompilation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
