...
class SalarypayslipApi
{
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperPayslip
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperPayslip, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperPayslip';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperPayslip',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponsePayslip
     */
    public function search($id = null, $employee_id = null, $wage_transaction_id = null, $activity_id = null, $year_from = null, $year_to = null, $month_from = null, $month_to = null, $voucher_date_from = null, $voucher_date_to = null, $comment = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponsePayslip, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $employee_id = null, $wage_transaction_id = null, $activity_id = null, $year_from = null, $year_to = null, $month_from = null, $month_to = null, $voucher_date_from = null, $voucher_date_to = null, $comment = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponsePayslip';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponsePayslip',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $employee_id = null, $wage_transaction_id = null, $activity_id = null, $year_from = null, $year_to = null, $month_from = null, $month_to = null, $voucher_date_from = null, $voucher_date_to = null, $comment = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $employee_id = null, $wage_transaction_id = null, $activity_id = null, $year_from = null, $year_to = null, $month_from = null, $month_to = null, $voucher_date_from = null, $voucher_date_to = null, $comment = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponsePayslip';
        $request = $this->searchRequest($id, $employee_id, $wage_transaction_id, $activity_id, $year_from, $year_to, $month_from, $month_to, $voucher_date_from, $voucher_date_to, $comment, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $employee_id = null, $wage_transaction_id = null, $activity_id = null, $year_from = null, $year_to = null, $month_from = null, $month_to = null, $voucher_date_from = null, $voucher_date_to = null, $comment = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($wage_transaction_id !== null) {
            $queryParams['wageTransactionId'] = ObjectSerializer::toQueryValue($wage_transaction_id);
        }
        // query params
        if ($activity_id !== null) {
        ...
        // query params
        if ($month_from !== null) {
            $queryParams['monthFrom'] = ObjectSerializer::toQueryValue($month_from);
        }
        // query params
        if ($month_to !== null) {
            $queryParams['monthTo'] = ObjectSerializer::toQueryValue($month_to);
        }
        // query params
        if ($voucher_date_from !== null) {
            $queryParams['voucherDateFrom'] = ObjectSerializer::toQueryValue($voucher_date_from);
        }
        // query params
        if ($voucher_date_to !== null) {
            $queryParams['voucherDateTo'] = ObjectSerializer::toQueryValue($voucher_date_to);
        }
        // query params
        if ($comment !== null) {
