...
class TravelExpensepaymentTypeApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperTravelPaymentType
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperTravelPaymentType, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperTravelPaymentType';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperTravelPaymentType',
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseTravelPaymentType
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseTravelPaymentType, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Tripletex\Model\ListResponseTravelPaymentType';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseTravelPaymentType',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
