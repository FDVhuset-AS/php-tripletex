...
class BankreconciliationmatchApi
{
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperBankReconciliationMatch
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperBankReconciliationMatch, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperBankReconciliationMatch';
     ...
     *
     * @param  \Tripletex\Model\BankReconciliationMatch $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperBankReconciliationMatch
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseBankReconciliationMatch
     */
    public function search($id = null, $bank_reconciliation_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $bank_reconciliation_id, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseBankReconciliationMatch, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $bank_reconciliation_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseBankReconciliationMatch';
        $request = $this->searchRequest($id, $bank_reconciliation_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $bank_reconciliation_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $bank_reconciliation_id, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $bank_reconciliation_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseBankReconciliationMatch';
        $request = $this->searchRequest($id, $bank_reconciliation_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $bank_reconciliation_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($bank_reconciliation_id !== null) {
            $queryParams['bankReconciliationId'] = ObjectSerializer::toQueryValue($bank_reconciliation_id);
        }
        // query params
        if ($from !== null) {
