...
class TravelExpensemileageAllowanceApi
{
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperMileageAllowance
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperMileageAllowance, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperMileageAllowance';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperMileageAllowance',
     ...
     *
     * @param  \Tripletex\Model\MileageAllowance $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperMileageAllowance
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\MileageAllowance $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperMileageAllowance
     ...
     * @param  float $km_from From and including (optional)
     * @param  float $km_to To and excluding (optional)
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseMileageAllowance, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $km_from = null, $km_to = null, $rate_from = null, $rate_to = null, $amount_from = null, $amount_to = null, $departure_location = null, $destination = null, $date_from = null, $date_to = null, $is_company_car = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseMileageAllowance';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseMileageAllowance',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function searchRequest($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $km_from = null, $km_to = null, $rate_from = null, $rate_to = null, $amount_from = null, $amount_to = null, $departure_location = null, $destination = null, $date_from = null, $date_to = null, $is_company_car = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        // query params
        if ($km_from !== null) {
            $queryParams['kmFrom'] = ObjectSerializer::toQueryValue($km_from);
        }
        // query params
        if ($km_to !== null) {
            $queryParams['kmTo'] = ObjectSerializer::toQueryValue($km_to);
        }
        // query params
        if ($rate_from !== null) {
        ...
        if ($departure_location !== null) {
            $queryParams['departureLocation'] = ObjectSerializer::toQueryValue($departure_location);
        }
        // query params
        if ($destination !== null) {
        ...
        if ($is_company_car !== null) {
            $queryParams['isCompanyCar'] = ObjectSerializer::toQueryValue($is_company_car);
        }
        // query params
        if ($from !== null) {
