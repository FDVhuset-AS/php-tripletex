...
class EmployeeemploymentoccupationCodeApi
{
     ...
     * @return \Tripletex\Model\ListResponseOccupationCode
     */
    public function search($name_no = null, $code = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($name_no, $code, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseOccupationCode, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($name_no = null, $code = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseOccupationCode';
        $request = $this->searchRequest($name_no, $code, $from, $count, $sorting, $fields);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseOccupationCode',
     ...
     */
    public function searchAsync($name_no = null, $code = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($name_no, $code, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($name_no = null, $code = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseOccupationCode';
        $request = $this->searchRequest($name_no, $code, $from, $count, $sorting, $fields);
     ...
     */
    protected function searchRequest($name_no = null, $code = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        // query params
        if ($name_no !== null) {
            $queryParams['nameNO'] = ObjectSerializer::toQueryValue($name_no);
        }
        // query params
        if ($code !== null) {
