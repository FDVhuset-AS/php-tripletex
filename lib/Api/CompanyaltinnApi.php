...
class CompanyaltinnApi
{
     ...
     *
     * @param  \Tripletex\Model\AltinnCompanyModule $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperAltinnCompanyModule
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperAltinnCompanyModule, HTTP status code, HTTP response headers (array of strings)
     */
    public function putWithHttpInfo($body = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperAltinnCompanyModule';
