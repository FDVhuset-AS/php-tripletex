...
class LedgervoucherApi
{
     ...
     */
    public function importDocument($file, $description, $split = null)
    {
     ...
     */
    public function importDocumentWithHttpInfo($file, $description, $split = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importDocumentAsync($file, $description, $split = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importDocumentAsyncWithHttpInfo($file, $description, $split = null)
    {
        $returnType = '\Tripletex\Model\ListResponseVoucher';
        $request = $this->importDocumentRequest($file, $description, $split);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function importDocumentRequest($file, $description, $split = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperVoucherOptions
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperVoucherOptions, HTTP status code, HTTP response headers (array of strings)
     */
    public function optionsWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperVoucherOptions';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperVoucherOptions',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
