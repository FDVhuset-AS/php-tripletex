...
class MunicipalityApi
{
     ...
     *
     * @param  bool $include_payroll_tax_zones Equals (optional)
     ...
     * @return \Tripletex\Model\ListResponseMunicipality
     */
    public function search($include_payroll_tax_zones = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseMunicipality, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($include_payroll_tax_zones = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseMunicipality';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseMunicipality',
     ...
     */
    public function searchAsync($include_payroll_tax_zones = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($include_payroll_tax_zones = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseMunicipality';
        $request = $this->searchRequest($include_payroll_tax_zones, $from, $count, $sorting, $fields);
     ...
     */
    protected function searchRequest($include_payroll_tax_zones = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($include_payroll_tax_zones !== null) {
            $queryParams['includePayrollTaxZones'] = ObjectSerializer::toQueryValue($include_payroll_tax_zones);
        }
        // query params
        if ($from !== null) {
