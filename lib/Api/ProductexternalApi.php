...
class ProductexternalApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperExternalProduct
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperExternalProduct, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperExternalProduct';
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseExternalProduct
     */
    public function search($name = null, $wholesaler = null, $organization_number = null, $el_number = null, $nrf_number = null, $is_inactive = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseExternalProduct, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($name = null, $wholesaler = null, $organization_number = null, $el_number = null, $nrf_number = null, $is_inactive = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseExternalProduct';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($name = null, $wholesaler = null, $organization_number = null, $el_number = null, $nrf_number = null, $is_inactive = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($name = null, $wholesaler = null, $organization_number = null, $el_number = null, $nrf_number = null, $is_inactive = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseExternalProduct';
        $request = $this->searchRequest($name, $wholesaler, $organization_number, $el_number, $nrf_number, $is_inactive, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($name = null, $wholesaler = null, $organization_number = null, $el_number = null, $nrf_number = null, $is_inactive = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        // query params
        if ($wholesaler !== null) {
            $queryParams['wholesaler'] = ObjectSerializer::toQueryValue($wholesaler);
        }
        // query params
        ...
        // query params
        if ($el_number !== null) {
            $queryParams['elNumber'] = ObjectSerializer::toQueryValue($el_number);
        }
        // query params
        if ($nrf_number !== null) {
            $queryParams['nrfNumber'] = ObjectSerializer::toQueryValue($nrf_number);
        }
        // query params
        if ($is_inactive !== null) {
