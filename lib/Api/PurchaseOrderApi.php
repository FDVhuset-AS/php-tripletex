...
class PurchaseOrderApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperPurchaseOrder
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperPurchaseOrder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperPurchaseOrder';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperPurchaseOrder',
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponsePurchaseOrder
     */
    public function search($number = null, $delivery_date_from = null, $delivery_date_to = null, $creation_date_from = null, $creation_date_to = null, $id = null, $supplier_id = null, $project_id = null, $is_closed = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($number, $delivery_date_from, $delivery_date_to, $creation_date_from, $creation_date_to, $id, $supplier_id, $project_id, $is_closed, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponsePurchaseOrder, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($number = null, $delivery_date_from = null, $delivery_date_to = null, $creation_date_from = null, $creation_date_to = null, $id = null, $supplier_id = null, $project_id = null, $is_closed = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponsePurchaseOrder';
        $request = $this->searchRequest($number, $delivery_date_from, $delivery_date_to, $creation_date_from, $creation_date_to, $id, $supplier_id, $project_id, $is_closed, $from, $count, $sorting, $fields);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponsePurchaseOrder',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($number = null, $delivery_date_from = null, $delivery_date_to = null, $creation_date_from = null, $creation_date_to = null, $id = null, $supplier_id = null, $project_id = null, $is_closed = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($number, $delivery_date_from, $delivery_date_to, $creation_date_from, $creation_date_to, $id, $supplier_id, $project_id, $is_closed, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($number = null, $delivery_date_from = null, $delivery_date_to = null, $creation_date_from = null, $creation_date_to = null, $id = null, $supplier_id = null, $project_id = null, $is_closed = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponsePurchaseOrder';
        $request = $this->searchRequest($number, $delivery_date_from, $delivery_date_to, $creation_date_from, $creation_date_to, $id, $supplier_id, $project_id, $is_closed, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($number = null, $delivery_date_from = null, $delivery_date_to = null, $creation_date_from = null, $creation_date_to = null, $id = null, $supplier_id = null, $project_id = null, $is_closed = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($delivery_date_from !== null) {
            $queryParams['deliveryDateFrom'] = ObjectSerializer::toQueryValue($delivery_date_from);
        }
        // query params
        if ($delivery_date_to !== null) {
            $queryParams['deliveryDateTo'] = ObjectSerializer::toQueryValue($delivery_date_to);
        }
        // query params
        if ($creation_date_from !== null) {
            $queryParams['creationDateFrom'] = ObjectSerializer::toQueryValue($creation_date_from);
        }
        // query params
        if ($creation_date_to !== null) {
            $queryParams['creationDateTo'] = ObjectSerializer::toQueryValue($creation_date_to);
        }
        // query params
        if ($id !== null) {
