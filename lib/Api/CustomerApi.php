...
class CustomerApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperCustomer
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperCustomer, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperCustomer';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperCustomer',
     ...
     *
     * @param  \Tripletex\Model\Customer $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperCustomer
     ...
     *
     * @param  \Tripletex\Model\Customer[] $body JSON representing a list of new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseCustomer
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseCustomer, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Tripletex\Model\ListResponseCustomer';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseCustomer',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\Customer $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperCustomer
     ...
     *
     * @param  \Tripletex\Model\Customer[] $body JSON representing updates to object. Should have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseCustomer
     ...
     * @return \Tripletex\Model\ListResponseCustomer
     */
    public function search($id = null, $customer_account_number = null, $organization_number = null, $email = null, $invoice_email = null, $is_inactive = null, $account_manager_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $customer_account_number, $organization_number, $email, $invoice_email, $is_inactive, $account_manager_id, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Tripletex\Model\ListResponseCustomer, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $customer_account_number = null, $organization_number = null, $email = null, $invoice_email = null, $is_inactive = null, $account_manager_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseCustomer';
        $request = $this->searchRequest($id, $customer_account_number, $organization_number, $email, $invoice_email, $is_inactive, $account_manager_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $customer_account_number = null, $organization_number = null, $email = null, $invoice_email = null, $is_inactive = null, $account_manager_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $customer_account_number, $organization_number, $email, $invoice_email, $is_inactive, $account_manager_id, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $customer_account_number = null, $organization_number = null, $email = null, $invoice_email = null, $is_inactive = null, $account_manager_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseCustomer';
        $request = $this->searchRequest($id, $customer_account_number, $organization_number, $email, $invoice_email, $is_inactive, $account_manager_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $customer_account_number = null, $organization_number = null, $email = null, $invoice_email = null, $is_inactive = null, $account_manager_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($customer_account_number !== null) {
            $queryParams['customerAccountNumber'] = ObjectSerializer::toQueryValue($customer_account_number);
        }
        // query params
