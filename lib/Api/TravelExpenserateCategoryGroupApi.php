...
class TravelExpenserateCategoryGroupApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperTravelExpenseRateCategoryGroup
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperTravelExpenseRateCategoryGroup, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperTravelExpenseRateCategoryGroup';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperTravelExpenseRateCategoryGroup',
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseTravelExpenseRateCategoryGroup
     */
    public function search($name = null, $is_foreign_travel = null, $date_from = null, $date_to = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseTravelExpenseRateCategoryGroup, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($name = null, $is_foreign_travel = null, $date_from = null, $date_to = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseTravelExpenseRateCategoryGroup';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseTravelExpenseRateCategoryGroup',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($name = null, $is_foreign_travel = null, $date_from = null, $date_to = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($name = null, $is_foreign_travel = null, $date_from = null, $date_to = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseTravelExpenseRateCategoryGroup';
        $request = $this->searchRequest($name, $is_foreign_travel, $date_from, $date_to, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($name = null, $is_foreign_travel = null, $date_from = null, $date_to = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($is_foreign_travel !== null) {
            $queryParams['isForeignTravel'] = ObjectSerializer::toQueryValue($is_foreign_travel);
        }
        // query params
        if ($date_from !== null) {
