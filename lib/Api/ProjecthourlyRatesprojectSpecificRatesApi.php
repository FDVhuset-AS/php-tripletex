...
class ProjecthourlyRatesprojectSpecificRatesApi
{
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperProjectSpecificRate
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperProjectSpecificRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperProjectSpecificRate';
     ...
     *
     * @param  \Tripletex\Model\ProjectSpecificRate $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperProjectSpecificRate
     ...
     *
     * @param  \Tripletex\Model\ProjectSpecificRate[] $body JSON representing a list of new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseProjectSpecificRate
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseProjectSpecificRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Tripletex\Model\ListResponseProjectSpecificRate';
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\ProjectSpecificRate $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperProjectSpecificRate
     ...
     *
     * @param  \Tripletex\Model\ProjectSpecificRate[] $body JSON representing updates to object. Should have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseProjectSpecificRate
     ...
     * @return \Tripletex\Model\ListResponseProjectSpecificRate
     */
    public function search($id = null, $project_hourly_rate_id = null, $employee_id = null, $activity_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return array of \Tripletex\Model\ListResponseProjectSpecificRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $project_hourly_rate_id = null, $employee_id = null, $activity_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseProjectSpecificRate';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $project_hourly_rate_id = null, $employee_id = null, $activity_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $project_hourly_rate_id = null, $employee_id = null, $activity_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseProjectSpecificRate';
        $request = $this->searchRequest($id, $project_hourly_rate_id, $employee_id, $activity_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $project_hourly_rate_id = null, $employee_id = null, $activity_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($project_hourly_rate_id !== null) {
            $queryParams['projectHourlyRateId'] = ObjectSerializer::toQueryValue($project_hourly_rate_id);
        }
        // query params
        if ($employee_id !== null) {
