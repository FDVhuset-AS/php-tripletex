...
class ProjecthourlyRatesApi
{
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperProjectHourlyRate
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperProjectHourlyRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperProjectHourlyRate';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperProjectHourlyRate',
     ...
     *
     * @param  \Tripletex\Model\ProjectHourlyRate $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperProjectHourlyRate
     ...
     *
     * @param  \Tripletex\Model\ProjectHourlyRate[] $body JSON representing a list of new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseProjectHourlyRate
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseProjectHourlyRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Tripletex\Model\ListResponseProjectHourlyRate';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseProjectHourlyRate',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\ProjectHourlyRate $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperProjectHourlyRate
     ...
     *
     * @param  \Tripletex\Model\ProjectHourlyRate[] $body JSON representing updates to object. Should have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseProjectHourlyRate
     ...
     * @return \Tripletex\Model\ListResponseProjectHourlyRate
     */
    public function search($id = null, $project_id = null, $type = null, $start_date_from = null, $start_date_to = null, $show_in_project_order = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return array of \Tripletex\Model\ListResponseProjectHourlyRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $project_id = null, $type = null, $start_date_from = null, $start_date_to = null, $show_in_project_order = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseProjectHourlyRate';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $project_id = null, $type = null, $start_date_from = null, $start_date_to = null, $show_in_project_order = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $project_id = null, $type = null, $start_date_from = null, $start_date_to = null, $show_in_project_order = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseProjectHourlyRate';
        $request = $this->searchRequest($id, $project_id, $type, $start_date_from, $start_date_to, $show_in_project_order, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $project_id = null, $type = null, $start_date_from = null, $start_date_to = null, $show_in_project_order = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($show_in_project_order !== null) {
            $queryParams['showInProjectOrder'] = ObjectSerializer::toQueryValue($show_in_project_order);
        }
        // query params
        if ($from !== null) {
