...
class LedgeraccountingPeriodApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperAccountingPeriod
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperAccountingPeriod, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperAccountingPeriod';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperAccountingPeriod',
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseAccountingPeriod
     */
    public function search($id = null, $number_from = null, $number_to = null, $start_from = null, $start_to = null, $end_from = null, $end_to = null, $count = null, $from = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseAccountingPeriod, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $number_from = null, $number_to = null, $start_from = null, $start_to = null, $end_from = null, $end_to = null, $count = null, $from = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseAccountingPeriod';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseAccountingPeriod',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $number_from = null, $number_to = null, $start_from = null, $start_to = null, $end_from = null, $end_to = null, $count = null, $from = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $number_from = null, $number_to = null, $start_from = null, $start_to = null, $end_from = null, $end_to = null, $count = null, $from = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseAccountingPeriod';
        $request = $this->searchRequest($id, $number_from, $number_to, $start_from, $start_to, $end_from, $end_to, $count, $from, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $number_from = null, $number_to = null, $start_from = null, $start_to = null, $end_from = null, $end_to = null, $count = null, $from = null, $sorting = null, $fields = null)
    {
        ...
        // query params
        if ($start_to !== null) {
            $queryParams['startTo'] = ObjectSerializer::toQueryValue($start_to);
        }
        // query params
        if ($end_from !== null) {
            $queryParams['endFrom'] = ObjectSerializer::toQueryValue($end_from);
        }
        // query params
        if ($end_to !== null) {
            $queryParams['endTo'] = ObjectSerializer::toQueryValue($end_to);
        }
        // query params
        if ($count !== null) {
