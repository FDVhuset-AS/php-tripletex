...
class TravelExpenseaccommodationAllowanceApi
{
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperAccommodationAllowance
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperAccommodationAllowance, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperAccommodationAllowance';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperAccommodationAllowance',
     ...
     *
     * @param  \Tripletex\Model\AccommodationAllowance $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperAccommodationAllowance
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\AccommodationAllowance $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperAccommodationAllowance
     ...
     * @param  float $rate_from From and including (optional)
     * @param  float $rate_to To and excluding (optional)
     * @param  int $count_from From and including (optional)
     * @param  int $count_to To and excluding (optional)
     * @param  float $amount_from From and including (optional)
     * @param  float $amount_to To and excluding (optional)
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseAccommodationAllowance
     */
    public function search($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseAccommodationAllowance, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseAccommodationAllowance';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseAccommodationAllowance',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseAccommodationAllowance';
        $request = $this->searchRequest($travel_expense_id, $rate_type_id, $rate_category_id, $rate_from, $rate_to, $count_from, $count_to, $amount_from, $amount_to, $location, $address, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($travel_expense_id !== null) {
            $queryParams['travelExpenseId'] = ObjectSerializer::toQueryValue($travel_expense_id);
        }
        // query params
        if ($rate_type_id !== null) {
            $queryParams['rateTypeId'] = ObjectSerializer::toQueryValue($rate_type_id);
        }
        // query params
        if ($rate_category_id !== null) {
            $queryParams['rateCategoryId'] = ObjectSerializer::toQueryValue($rate_category_id);
        }
        // query params
        if ($rate_from !== null) {
            $queryParams['rateFrom'] = ObjectSerializer::toQueryValue($rate_from);
        }
        // query params
        if ($rate_to !== null) {
            $queryParams['rateTo'] = ObjectSerializer::toQueryValue($rate_to);
        }
        // query params
        if ($count_from !== null) {
            $queryParams['countFrom'] = ObjectSerializer::toQueryValue($count_from);
        }
        // query params
        if ($count_to !== null) {
            $queryParams['countTo'] = ObjectSerializer::toQueryValue($count_to);
        }
        // query params
        if ($amount_from !== null) {
            $queryParams['amountFrom'] = ObjectSerializer::toQueryValue($amount_from);
        }
        // query params
        if ($amount_to !== null) {
            $queryParams['amountTo'] = ObjectSerializer::toQueryValue($amount_to);
        }
        // query params
        if ($location !== null) {
