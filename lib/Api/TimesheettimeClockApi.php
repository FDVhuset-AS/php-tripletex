...
class TimesheettimeClockApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperTimeClock
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperTimeClock, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperTimeClock';
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\TimeClock $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperTimeClock
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseTimeClock
     */
    public function search($id = null, $employee_id = null, $project_id = null, $activity_id = null, $date_from = null, $date_to = null, $hour_id = null, $is_running = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseTimeClock, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $employee_id = null, $project_id = null, $activity_id = null, $date_from = null, $date_to = null, $hour_id = null, $is_running = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseTimeClock';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $employee_id = null, $project_id = null, $activity_id = null, $date_from = null, $date_to = null, $hour_id = null, $is_running = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $employee_id = null, $project_id = null, $activity_id = null, $date_from = null, $date_to = null, $hour_id = null, $is_running = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseTimeClock';
        $request = $this->searchRequest($id, $employee_id, $project_id, $activity_id, $date_from, $date_to, $hour_id, $is_running, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $employee_id = null, $project_id = null, $activity_id = null, $date_from = null, $date_to = null, $hour_id = null, $is_running = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        // query params
        if ($hour_id !== null) {
            $queryParams['hourId'] = ObjectSerializer::toQueryValue($hour_id);
        }
        // query params
        if ($is_running !== null) {
            $queryParams['isRunning'] = ObjectSerializer::toQueryValue($is_running);
        }
        // query params
        if ($from !== null) {
     ...
     * @return \Tripletex\Model\ResponseWrapperTimeClock
     */
    public function start($activity_id, $employee_id = null, $project_id = null, $date = null)
    {
        list($response) = $this->startWithHttpInfo($activity_id, $employee_id, $project_id, $date);
        return $response;
    }
     ...
     * @return array of \Tripletex\Model\ResponseWrapperTimeClock, HTTP status code, HTTP response headers (array of strings)
     */
    public function startWithHttpInfo($activity_id, $employee_id = null, $project_id = null, $date = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperTimeClock';
        $request = $this->startRequest($activity_id, $employee_id, $project_id, $date);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function startAsync($activity_id, $employee_id = null, $project_id = null, $date = null)
    {
        return $this->startAsyncWithHttpInfo($activity_id, $employee_id, $project_id, $date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function startAsyncWithHttpInfo($activity_id, $employee_id = null, $project_id = null, $date = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperTimeClock';
        $request = $this->startRequest($activity_id, $employee_id, $project_id, $date);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function startRequest($activity_id, $employee_id = null, $project_id = null, $date = null)
    {
     ...
     * @return void
     */
    public function stop($id, $version = null)
    {
     ...
     */
    public function stopWithHttpInfo($id, $version = null)
    {
        $returnType = '';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function stopAsync($id, $version = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function stopAsyncWithHttpInfo($id, $version = null)
    {
        $returnType = '';
        $request = $this->stopRequest($id, $version);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function stopRequest($id, $version = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
