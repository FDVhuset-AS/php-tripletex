...
class CrmprospectApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperProspect
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperProspect, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperProspect';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperProspect',
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseProspect, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($name = null, $description = null, $created_date_from = null, $created_date_to = null, $customer_id = null, $sales_employee_id = null, $is_closed = null, $closed_reason = null, $closed_date_from = null, $closed_date_to = null, $competitor = null, $prospect_type = null, $project_id = null, $project_offer_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseProspect';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseProspect',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function searchRequest($name = null, $description = null, $created_date_from = null, $created_date_to = null, $customer_id = null, $sales_employee_id = null, $is_closed = null, $closed_reason = null, $closed_date_from = null, $closed_date_to = null, $competitor = null, $prospect_type = null, $project_id = null, $project_offer_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($created_date_from !== null) {
            $queryParams['createdDateFrom'] = ObjectSerializer::toQueryValue($created_date_from);
        }
        // query params
        if ($created_date_to !== null) {
            $queryParams['createdDateTo'] = ObjectSerializer::toQueryValue($created_date_to);
        }
        // query params
        if ($customer_id !== null) {
        ...
        if ($sales_employee_id !== null) {
            $queryParams['salesEmployeeId'] = ObjectSerializer::toQueryValue($sales_employee_id);
        }
        // query params
        if ($is_closed !== null) {
        ...
        if ($closed_reason !== null) {
            $queryParams['closedReason'] = ObjectSerializer::toQueryValue($closed_reason);
        }
        // query params
        if ($closed_date_from !== null) {
            $queryParams['closedDateFrom'] = ObjectSerializer::toQueryValue($closed_date_from);
        }
        // query params
        if ($closed_date_to !== null) {
            $queryParams['closedDateTo'] = ObjectSerializer::toQueryValue($closed_date_to);
        }
        // query params
        if ($competitor !== null) {
            $queryParams['competitor'] = ObjectSerializer::toQueryValue($competitor);
        }
        // query params
        if ($prospect_type !== null) {
            $queryParams['prospectType'] = ObjectSerializer::toQueryValue($prospect_type);
        }
        // query params
        if ($project_id !== null) {
        ...
        if ($project_offer_id !== null) {
            $queryParams['projectOfferId'] = ObjectSerializer::toQueryValue($project_offer_id);
        }
        // query params
        if ($from !== null) {
