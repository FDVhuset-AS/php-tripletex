...
class TravelExpensesettingsApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperTravelExpenseSettings
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperTravelExpenseSettings, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperTravelExpenseSettings';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperTravelExpenseSettings',
