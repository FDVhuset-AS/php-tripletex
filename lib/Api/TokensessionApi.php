...
class TokensessionApi
{
     ...
     * @param  string $employee_token The employees token (required)
     ...
     * @return \Tripletex\Model\ResponseWrapperSessionToken
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperSessionToken, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($consumer_token, $employee_token, $expiration_date)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperSessionToken';
    ...
    protected function createRequest($consumer_token, $employee_token, $expiration_date)
    {
        ...
        if ($consumer_token !== null) {
            $queryParams['consumerToken'] = ObjectSerializer::toQueryValue($consumer_token);
        }
        // query params
        if ($employee_token !== null) {
            $queryParams['employeeToken'] = ObjectSerializer::toQueryValue($employee_token);
        }
        // query params
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperLoggedInUserInfoDTO
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperLoggedInUserInfoDTO, HTTP status code, HTTP response headers (array of strings)
     */
    public function whoAmIWithHttpInfo($fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperLoggedInUserInfoDTO';
