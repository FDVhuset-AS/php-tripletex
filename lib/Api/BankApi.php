...
class BankApi
{
     ...
     * @return \Tripletex\Model\ListResponseBank
     */
    public function search($id = null, $register_numbers = null, $is_bank_reconciliation_support = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $register_numbers, $is_bank_reconciliation_support, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseBank, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $register_numbers = null, $is_bank_reconciliation_support = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseBank';
        $request = $this->searchRequest($id, $register_numbers, $is_bank_reconciliation_support, $from, $count, $sorting, $fields);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseBank',
     ...
     */
    public function searchAsync($id = null, $register_numbers = null, $is_bank_reconciliation_support = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $register_numbers, $is_bank_reconciliation_support, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $register_numbers = null, $is_bank_reconciliation_support = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseBank';
        $request = $this->searchRequest($id, $register_numbers, $is_bank_reconciliation_support, $from, $count, $sorting, $fields);
     ...
     */
    protected function searchRequest($id = null, $register_numbers = null, $is_bank_reconciliation_support = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($register_numbers !== null) {
            $queryParams['registerNumbers'] = ObjectSerializer::toQueryValue($register_numbers);
        }
        // query params
        if ($is_bank_reconciliation_support !== null) {
            $queryParams['isBankReconciliationSupport'] = ObjectSerializer::toQueryValue($is_bank_reconciliation_support);
        }
        // query params
        if ($from !== null) {
