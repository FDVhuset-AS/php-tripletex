...
class TokenemployeeApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperEmployeeToken
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperEmployeeToken, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($token_name, $consumer_name, $employee_id, $company_owned, $expiration_date)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperEmployeeToken';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperEmployeeToken',
    ...
    protected function createRequest($token_name, $consumer_name, $employee_id, $company_owned, $expiration_date)
    {
        ...
        // query params
        if ($token_name !== null) {
            $queryParams['tokenName'] = ObjectSerializer::toQueryValue($token_name);
        }
        // query params
        if ($consumer_name !== null) {
            $queryParams['consumerName'] = ObjectSerializer::toQueryValue($consumer_name);
        }
        // query params
        if ($employee_id !== null) {
        ...
        if ($company_owned !== null) {
            $queryParams['companyOwned'] = ObjectSerializer::toQueryValue($company_owned);
        }
        // query params
