...
class DeliveryAddressApi
{
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseDeliveryAddress
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseDeliveryAddress, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Tripletex\Model\ListResponseDeliveryAddress';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseDeliveryAddress',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
