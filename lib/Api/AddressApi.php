...
class AddressApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperLegacyAddress
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperLegacyAddress, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperLegacyAddress';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperLegacyAddress',
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\LegacyAddress $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperLegacyAddress
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\DeliveryAddress $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperDeliveryAddress
     */
    public function put_0($id, $body = null)
    {
        list($response) = $this->put_0WithHttpInfo($id, $body);
        return $response;
    }

    /**
     * Operation put_0WithHttpInfo
     *
     * Update address.
     *
     * @param  int $id Element ID (required)
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperDeliveryAddress, HTTP status code, HTTP response headers (array of strings)
     */
    public function put_0WithHttpInfo($id, $body = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperDeliveryAddress';
        $request = $this->put_0Request($id, $body);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperDeliveryAddress',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function put_0Async($id, $body = null)
    {
        return $this->put_0AsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation put_0AsyncWithHttpInfo
     *
     * Update address.
     *
     * @param  int $id Element ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function put_0AsyncWithHttpInfo($id, $body = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperDeliveryAddress';
        $request = $this->put_0Request($id, $body);
    ...
    /**
     * Create request for operation 'put_0'
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\DeliveryAddress $body Partial object describing what should be updated (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function put_0Request($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling put_0'
            );
        }
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseLegacyAddress
     */
    public function search($id = null, $address_line1 = null, $address_line2 = null, $postal_code = null, $city = null, $name = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseLegacyAddress, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $address_line1 = null, $address_line2 = null, $postal_code = null, $city = null, $name = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseLegacyAddress';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseLegacyAddress',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $address_line1 = null, $address_line2 = null, $postal_code = null, $city = null, $name = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $address_line1 = null, $address_line2 = null, $postal_code = null, $city = null, $name = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseLegacyAddress';
        $request = $this->searchRequest($id, $address_line1, $address_line2, $postal_code, $city, $name, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $address_line1 = null, $address_line2 = null, $postal_code = null, $city = null, $name = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($address_line1 !== null) {
            $queryParams['addressLine1'] = ObjectSerializer::toQueryValue($address_line1);
        }
        // query params
        if ($address_line2 !== null) {
            $queryParams['addressLine2'] = ObjectSerializer::toQueryValue($address_line2);
        }
        // query params
        if ($postal_code !== null) {
