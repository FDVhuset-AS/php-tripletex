...
class TokenconsumerApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperConsumerToken
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperConsumerToken, HTTP status code, HTTP response headers (array of strings)
     */
    public function getByTokenWithHttpInfo($token, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperConsumerToken';
