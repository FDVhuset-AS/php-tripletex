...
class SalarysettingsApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperSalarySettings
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperSalarySettings, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperSalarySettings';
     ...
     *
     * @param  \Tripletex\Model\SalarySettings $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperSalarySettings
