...
class LedgerpaymentTypeOutApi
{
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperPaymentTypeOut
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperPaymentTypeOut, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperPaymentTypeOut';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperPaymentTypeOut',
     ...
     *
     * @param  \Tripletex\Model\PaymentTypeOut $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperPaymentTypeOut
     ...
     *
     * @param  \Tripletex\Model\PaymentTypeOut[] $body JSON representing a list of new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponsePaymentTypeOut
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponsePaymentTypeOut, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Tripletex\Model\ListResponsePaymentTypeOut';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponsePaymentTypeOut',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\PaymentTypeOut $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperPaymentTypeOut
     ...
     *
     * @param  \Tripletex\Model\PaymentTypeOut[] $body JSON representing updates to object. Should have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponsePaymentTypeOut
     ...
     * @return \Tripletex\Model\ListResponsePaymentTypeOut
     */
    public function search($id = null, $description = null, $is_inactive = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return array of \Tripletex\Model\ListResponsePaymentTypeOut, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $description = null, $is_inactive = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponsePaymentTypeOut';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $description = null, $is_inactive = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $description = null, $is_inactive = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponsePaymentTypeOut';
        $request = $this->searchRequest($id, $description, $is_inactive, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $description = null, $is_inactive = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
