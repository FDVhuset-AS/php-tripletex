...
class SalarytransactionApi
{
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperSalaryTransaction
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperSalaryTransaction, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperSalaryTransaction';
     ...
     *
     * @param  \Tripletex\Model\SalaryTransaction $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     * @param  bool $generate_tax_deduction Generate tax deduction (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperSalaryTransaction
     */
    public function post($body = null, $generate_tax_deduction = null)
    {
     ...
     * @return array of \Tripletex\Model\ResponseWrapperSalaryTransaction, HTTP status code, HTTP response headers (array of strings)
     */
    public function postWithHttpInfo($body = null, $generate_tax_deduction = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperSalaryTransaction';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postAsync($body = null, $generate_tax_deduction = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postAsyncWithHttpInfo($body = null, $generate_tax_deduction = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperSalaryTransaction';
        $request = $this->postRequest($body, $generate_tax_deduction);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postRequest($body = null, $generate_tax_deduction = null)
    {
        ...
        if ($generate_tax_deduction !== null) {
            $queryParams['generateTaxDeduction'] = ObjectSerializer::toQueryValue($generate_tax_deduction);
        }
