...
class CustomercategoryApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperCustomerCategory
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperCustomerCategory, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperCustomerCategory';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperCustomerCategory',
     ...
     *
     * @param  \Tripletex\Model\CustomerCategory $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperCustomerCategory
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\CustomerCategory $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperCustomerCategory
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseCustomerCategory
     */
    public function search($id = null, $name = null, $number = null, $description = null, $type = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseCustomerCategory, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $name = null, $number = null, $description = null, $type = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseCustomerCategory';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseCustomerCategory',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $name = null, $number = null, $description = null, $type = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $name = null, $number = null, $description = null, $type = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseCustomerCategory';
        $request = $this->searchRequest($id, $name, $number, $description, $type, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $name = null, $number = null, $description = null, $type = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
