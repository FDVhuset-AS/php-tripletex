...
class ActivityApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperActivity
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperActivity, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperActivity';
     ...
     */
    public function getForTimeSheet($project_id, $employee_id = null, $date = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     */
    public function getForTimeSheetWithHttpInfo($project_id, $employee_id = null, $date = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getForTimeSheetAsync($project_id, $employee_id = null, $date = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getForTimeSheetAsyncWithHttpInfo($project_id, $employee_id = null, $date = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseActivity';
        $request = $this->getForTimeSheetRequest($project_id, $employee_id, $date, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getForTimeSheetRequest($project_id, $employee_id = null, $date = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * Add activity.
     *
     * @param  \Tripletex\Model\Activity $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperActivity
     ...
     *
     * @param  \Tripletex\Model\Activity[] $body JSON representing a list of new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseActivity
     ...
     * @return \Tripletex\Model\ListResponseActivity
     */
    public function search($id = null, $name = null, $number = null, $description = null, $is_project_activity = null, $is_general = null, $is_chargeable = null, $is_task = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $name, $number, $description, $is_project_activity, $is_general, $is_chargeable, $is_task, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Tripletex\Model\ListResponseActivity, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $name = null, $number = null, $description = null, $is_project_activity = null, $is_general = null, $is_chargeable = null, $is_task = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseActivity';
        $request = $this->searchRequest($id, $name, $number, $description, $is_project_activity, $is_general, $is_chargeable, $is_task, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $name = null, $number = null, $description = null, $is_project_activity = null, $is_general = null, $is_chargeable = null, $is_task = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $name, $number, $description, $is_project_activity, $is_general, $is_chargeable, $is_task, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $name = null, $number = null, $description = null, $is_project_activity = null, $is_general = null, $is_chargeable = null, $is_task = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseActivity';
        $request = $this->searchRequest($id, $name, $number, $description, $is_project_activity, $is_general, $is_chargeable, $is_task, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $name = null, $number = null, $description = null, $is_project_activity = null, $is_general = null, $is_chargeable = null, $is_task = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($is_project_activity !== null) {
            $queryParams['isProjectActivity'] = ObjectSerializer::toQueryValue($is_project_activity);
        }
        // query params
        if ($is_general !== null) {
            $queryParams['isGeneral'] = ObjectSerializer::toQueryValue($is_general);
        }
        // query params
        if ($is_chargeable !== null) {
            $queryParams['isChargeable'] = ObjectSerializer::toQueryValue($is_chargeable);
        }
        // query params
        if ($is_task !== null) {
            $queryParams['isTask'] = ObjectSerializer::toQueryValue($is_task);
        }
        // query params
        if ($from !== null) {
            $queryParams['from'] = ObjectSerializer::toQueryValue($from);
