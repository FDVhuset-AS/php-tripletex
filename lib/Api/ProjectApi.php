...
class ProjectApi
{
     ...
     *
     * @param  \Tripletex\Model\Project[] $body JSON representing objects to delete. Should have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperProject
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperProject, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperProject';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperProject',
     ...
     */
    public function getForTimeSheet($employee_id = null, $date = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        list($response) = $this->getForTimeSheetWithHttpInfo($employee_id, $date, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     */
    public function getForTimeSheetWithHttpInfo($employee_id = null, $date = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseProject';
        $request = $this->getForTimeSheetRequest($employee_id, $date, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getForTimeSheetAsync($employee_id = null, $date = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        return $this->getForTimeSheetAsyncWithHttpInfo($employee_id, $date, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getForTimeSheetAsyncWithHttpInfo($employee_id = null, $date = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseProject';
        $request = $this->getForTimeSheetRequest($employee_id, $date, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getForTimeSheetRequest($employee_id = null, $date = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     *
     * @param  \Tripletex\Model\Project $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperProject
     ...
     *
     * @param  \Tripletex\Model\Project[] $body JSON representing a list of new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseProject
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\Project $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperProject
     ...
     *
     * @param  \Tripletex\Model\Project[] $body JSON representing updates to object. Should have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseProject
     ...
     * @return \Tripletex\Model\ListResponseProject
     */
    public function search($id = null, $name = null, $number = null, $is_offer = null, $project_manager_id = null, $employee_in_project_id = null, $department_id = null, $start_date_from = null, $start_date_to = null, $end_date_from = null, $end_date_to = null, $is_closed = null, $customer_id = null, $external_accounts_number = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $name, $number, $is_offer, $project_manager_id, $employee_in_project_id, $department_id, $start_date_from, $start_date_to, $end_date_from, $end_date_to, $is_closed, $customer_id, $external_accounts_number, $from, $count, $sorting, $fields);
        return $response;
    }
    ...
    {
        $returnType = '\Tripletex\Model\ListResponseProject';
        $request = $this->searchRequest($id, $name, $number, $is_offer, $project_manager_id, $employee_in_project_id, $department_id, $start_date_from, $start_date_to, $end_date_from, $end_date_to, $is_closed, $customer_id, $external_accounts_number, $from, $count, $sorting, $fields);
    ...
    {
        return $this->searchAsyncWithHttpInfo($id, $name, $number, $is_offer, $project_manager_id, $employee_in_project_id, $department_id, $start_date_from, $start_date_to, $end_date_from, $end_date_to, $is_closed, $customer_id, $external_accounts_number, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function searchRequest($id = null, $name = null, $number = null, $is_offer = null, $project_manager_id = null, $employee_in_project_id = null, $department_id = null, $start_date_from = null, $start_date_to = null, $end_date_from = null, $end_date_to = null, $is_closed = null, $customer_id = null, $external_accounts_number = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        // query params
        if ($is_offer !== null) {
            $queryParams['isOffer'] = ObjectSerializer::toQueryValue($is_offer);
        }
        // query params
        ...
        if ($employee_in_project_id !== null) {
            $queryParams['employeeInProjectId'] = ObjectSerializer::toQueryValue($employee_in_project_id);
        }
        // query params
        ...
        if ($start_date_from !== null) {
            $queryParams['startDateFrom'] = ObjectSerializer::toQueryValue($start_date_from);
        }
        // query params
        if ($start_date_to !== null) {
            $queryParams['startDateTo'] = ObjectSerializer::toQueryValue($start_date_to);
        }
        // query params
        if ($end_date_from !== null) {
            $queryParams['endDateFrom'] = ObjectSerializer::toQueryValue($end_date_from);
        }
        // query params
        if ($end_date_to !== null) {
            $queryParams['endDateTo'] = ObjectSerializer::toQueryValue($end_date_to);
        }
        // query params
        if ($is_closed !== null) {
        ...
        if ($external_accounts_number !== null) {
            $queryParams['externalAccountsNumber'] = ObjectSerializer::toQueryValue($external_accounts_number);
        }
        // query params
        if ($from !== null) {
            $queryParams['from'] = ObjectSerializer::toQueryValue($from);
