...
class BankstatementApi
{
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperBankStatement
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperBankStatement, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperBankStatement';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperBankStatement',
     ...
     * @return \Tripletex\Model\ResponseWrapperBankStatement
     */
    public function importBankStatement($file, $bank_id, $account_id, $from_date, $to_date, $file_format)
    {
        list($response) = $this->importBankStatementWithHttpInfo($file, $bank_id, $account_id, $from_date, $to_date, $file_format);
        return $response;
    }
     ...
     * @return array of \Tripletex\Model\ResponseWrapperBankStatement, HTTP status code, HTTP response headers (array of strings)
     */
    public function importBankStatementWithHttpInfo($file, $bank_id, $account_id, $from_date, $to_date, $file_format)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperBankStatement';
        $request = $this->importBankStatementRequest($file, $bank_id, $account_id, $from_date, $to_date, $file_format);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importBankStatementAsync($file, $bank_id, $account_id, $from_date, $to_date, $file_format)
    {
        return $this->importBankStatementAsyncWithHttpInfo($file, $bank_id, $account_id, $from_date, $to_date, $file_format)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importBankStatementAsyncWithHttpInfo($file, $bank_id, $account_id, $from_date, $to_date, $file_format)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperBankStatement';
        $request = $this->importBankStatementRequest($file, $bank_id, $account_id, $from_date, $to_date, $file_format);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function importBankStatementRequest($file, $bank_id, $account_id, $from_date, $to_date, $file_format)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseBankStatement
     */
    public function search($id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseBankStatement, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseBankStatement';
        $request = $this->searchRequest($id, $from, $count, $sorting, $fields);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseBankStatement',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseBankStatement';
        $request = $this->searchRequest($id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
