...
class EmployeeemploymentdetailsApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperEmploymentDetails
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperEmploymentDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperEmploymentDetails';
     ...
     *
     * @param  \Tripletex\Model\EmploymentDetails $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperEmploymentDetails
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\EmploymentDetails $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperEmploymentDetails
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseEmploymentDetails
     */
    public function search($employment_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseEmploymentDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($employment_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseEmploymentDetails';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($employment_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($employment_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseEmploymentDetails';
        $request = $this->searchRequest($employment_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($employment_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($employment_id !== null) {
            $queryParams['employmentId'] = ObjectSerializer::toQueryValue($employment_id);
        }
        // query params
        if ($from !== null) {
