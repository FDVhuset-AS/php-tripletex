...
class LedgeraccountApi
{
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperAccount
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperAccount';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperAccount',
     ...
     *
     * @param  \Tripletex\Model\Account $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperAccount
     ...
     *
     * @param  \Tripletex\Model\Account[] $body JSON representing a list of new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseAccount
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Tripletex\Model\ListResponseAccount';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseAccount',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\Account $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperAccount
     ...
     *
     * @param  \Tripletex\Model\Account[] $body JSON representing updates to object. Should have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseAccount
     ...
     * @return \Tripletex\Model\ListResponseAccount
     */
    public function search($id = null, $number = null, $is_bank_account = null, $is_inactive = null, $is_applicable_for_supplier_invoice = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $number, $is_bank_account, $is_inactive, $is_applicable_for_supplier_invoice, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Tripletex\Model\ListResponseAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $number = null, $is_bank_account = null, $is_inactive = null, $is_applicable_for_supplier_invoice = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseAccount';
        $request = $this->searchRequest($id, $number, $is_bank_account, $is_inactive, $is_applicable_for_supplier_invoice, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $number = null, $is_bank_account = null, $is_inactive = null, $is_applicable_for_supplier_invoice = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $number, $is_bank_account, $is_inactive, $is_applicable_for_supplier_invoice, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $number = null, $is_bank_account = null, $is_inactive = null, $is_applicable_for_supplier_invoice = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseAccount';
        $request = $this->searchRequest($id, $number, $is_bank_account, $is_inactive, $is_applicable_for_supplier_invoice, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $number = null, $is_bank_account = null, $is_inactive = null, $is_applicable_for_supplier_invoice = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($is_bank_account !== null) {
            $queryParams['isBankAccount'] = ObjectSerializer::toQueryValue($is_bank_account);
        }
        // query params
        if ($is_inactive !== null) {
        ...
        if ($is_applicable_for_supplier_invoice !== null) {
            $queryParams['isApplicableForSupplierInvoice'] = ObjectSerializer::toQueryValue($is_applicable_for_supplier_invoice);
        }
        // query params
        if ($from !== null) {
