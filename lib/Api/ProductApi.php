...
class ProductApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperProduct
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperProduct, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperProduct';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperProduct',
     ...
     * Create new product.
     *
     * @param  \Tripletex\Model\Product $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperProduct
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\Product $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperProduct
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseProduct, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($number = null, $product_number = null, $name = null, $ean = null, $is_inactive = null, $is_stock_item = null, $currency_id = null, $vat_type_id = null, $product_unit_id = null, $department_id = null, $account_id = null, $cost_excluding_vat_currency_from = null, $cost_excluding_vat_currency_to = null, $price_excluding_vat_currency_from = null, $price_excluding_vat_currency_to = null, $price_including_vat_currency_from = null, $price_including_vat_currency_to = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseProduct';
        $request = $this->searchRequest($number, $product_number, $name, $ean, $is_inactive, $is_stock_item, $currency_id, $vat_type_id, $product_unit_id, $department_id, $account_id, $cost_excluding_vat_currency_from, $cost_excluding_vat_currency_to, $price_excluding_vat_currency_from, $price_excluding_vat_currency_to, $price_including_vat_currency_from, $price_including_vat_currency_to, $from, $count, $sorting, $fields);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseProduct',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($number = null, $product_number = null, $name = null, $ean = null, $is_inactive = null, $is_stock_item = null, $currency_id = null, $vat_type_id = null, $product_unit_id = null, $department_id = null, $account_id = null, $cost_excluding_vat_currency_from = null, $cost_excluding_vat_currency_to = null, $price_excluding_vat_currency_from = null, $price_excluding_vat_currency_to = null, $price_including_vat_currency_from = null, $price_including_vat_currency_to = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($number, $product_number, $name, $ean, $is_inactive, $is_stock_item, $currency_id, $vat_type_id, $product_unit_id, $department_id, $account_id, $cost_excluding_vat_currency_from, $cost_excluding_vat_currency_to, $price_excluding_vat_currency_from, $price_excluding_vat_currency_to, $price_including_vat_currency_from, $price_including_vat_currency_to, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($number = null, $product_number = null, $name = null, $ean = null, $is_inactive = null, $is_stock_item = null, $currency_id = null, $vat_type_id = null, $product_unit_id = null, $department_id = null, $account_id = null, $cost_excluding_vat_currency_from = null, $cost_excluding_vat_currency_to = null, $price_excluding_vat_currency_from = null, $price_excluding_vat_currency_to = null, $price_including_vat_currency_from = null, $price_including_vat_currency_to = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseProduct';
        $request = $this->searchRequest($number, $product_number, $name, $ean, $is_inactive, $is_stock_item, $currency_id, $vat_type_id, $product_unit_id, $department_id, $account_id, $cost_excluding_vat_currency_from, $cost_excluding_vat_currency_to, $price_excluding_vat_currency_from, $price_excluding_vat_currency_to, $price_including_vat_currency_from, $price_including_vat_currency_to, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($number = null, $product_number = null, $name = null, $ean = null, $is_inactive = null, $is_stock_item = null, $currency_id = null, $vat_type_id = null, $product_unit_id = null, $department_id = null, $account_id = null, $cost_excluding_vat_currency_from = null, $cost_excluding_vat_currency_to = null, $price_excluding_vat_currency_from = null, $price_excluding_vat_currency_to = null, $price_including_vat_currency_from = null, $price_including_vat_currency_to = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($is_stock_item !== null) {
            $queryParams['isStockItem'] = ObjectSerializer::toQueryValue($is_stock_item);
        }
        // query params
        if ($currency_id !== null) {
        ...
        // query params
        if ($vat_type_id !== null) {
            $queryParams['vatTypeId'] = ObjectSerializer::toQueryValue($vat_type_id);
        }
        // query params
        ...
        if ($cost_excluding_vat_currency_from !== null) {
            $queryParams['costExcludingVatCurrencyFrom'] = ObjectSerializer::toQueryValue($cost_excluding_vat_currency_from);
        }
        // query params
        if ($cost_excluding_vat_currency_to !== null) {
            $queryParams['costExcludingVatCurrencyTo'] = ObjectSerializer::toQueryValue($cost_excluding_vat_currency_to);
        }
        // query params
        if ($price_excluding_vat_currency_from !== null) {
            $queryParams['priceExcludingVatCurrencyFrom'] = ObjectSerializer::toQueryValue($price_excluding_vat_currency_from);
        }
        // query params
        if ($price_excluding_vat_currency_to !== null) {
            $queryParams['priceExcludingVatCurrencyTo'] = ObjectSerializer::toQueryValue($price_excluding_vat_currency_to);
        }
        // query params
        if ($price_including_vat_currency_from !== null) {
            $queryParams['priceIncludingVatCurrencyFrom'] = ObjectSerializer::toQueryValue($price_including_vat_currency_from);
        }
        // query params
        if ($price_including_vat_currency_to !== null) {
            $queryParams['priceIncludingVatCurrencyTo'] = ObjectSerializer::toQueryValue($price_including_vat_currency_to);
        }
        // query params
        if ($from !== null) {
