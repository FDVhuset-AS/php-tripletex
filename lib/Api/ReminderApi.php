...
class ReminderApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperReminder
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperReminder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperReminder';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperReminder',
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseReminder
     */
    public function search($date_from, $date_to, $id = null, $term_of_payment_to = null, $term_of_payment_from = null, $invoice_id = null, $customer_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseReminder, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($date_from, $date_to, $id = null, $term_of_payment_to = null, $term_of_payment_from = null, $invoice_id = null, $customer_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseReminder';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseReminder',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($date_from, $date_to, $id = null, $term_of_payment_to = null, $term_of_payment_from = null, $invoice_id = null, $customer_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($date_from, $date_to, $id = null, $term_of_payment_to = null, $term_of_payment_from = null, $invoice_id = null, $customer_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseReminder';
        $request = $this->searchRequest($date_from, $date_to, $id, $term_of_payment_to, $term_of_payment_from, $invoice_id, $customer_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($date_from, $date_to, $id = null, $term_of_payment_to = null, $term_of_payment_from = null, $invoice_id = null, $customer_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($term_of_payment_to !== null) {
            $queryParams['termOfPaymentTo'] = ObjectSerializer::toQueryValue($term_of_payment_to);
        }
        // query params
        if ($term_of_payment_from !== null) {
            $queryParams['termOfPaymentFrom'] = ObjectSerializer::toQueryValue($term_of_payment_from);
        }
        // query params
        if ($invoice_id !== null) {
