...
class TravelExpensecostApi
{
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperCost
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperCost, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperCost';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperCost',
     ...
     * [BETA] Create cost.
     *
     * @param  \Tripletex\Model\Cost $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperCost
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\Cost $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperCost
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseCost
     */
    public function search($travel_expense_id = null, $vat_type_id = null, $currency_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseCost, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($travel_expense_id = null, $vat_type_id = null, $currency_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseCost';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseCost',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($travel_expense_id = null, $vat_type_id = null, $currency_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($travel_expense_id = null, $vat_type_id = null, $currency_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseCost';
        $request = $this->searchRequest($travel_expense_id, $vat_type_id, $currency_id, $rate_from, $rate_to, $count_from, $count_to, $amount_from, $amount_to, $location, $address, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($travel_expense_id = null, $vat_type_id = null, $currency_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
