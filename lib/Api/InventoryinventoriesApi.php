...
class InventoryinventoriesApi
{
     ...
     * @return \Tripletex\Model\ListResponseInventories
     */
    public function search($date_from, $date_to, $product_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($date_from, $date_to, $product_id, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseInventories, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($date_from, $date_to, $product_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseInventories';
        $request = $this->searchRequest($date_from, $date_to, $product_id, $from, $count, $sorting, $fields);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseInventories',
     ...
     */
    public function searchAsync($date_from, $date_to, $product_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($date_from, $date_to, $product_id, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($date_from, $date_to, $product_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseInventories';
        $request = $this->searchRequest($date_from, $date_to, $product_id, $from, $count, $sorting, $fields);
     ...
     */
    protected function searchRequest($date_from, $date_to, $product_id = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
