...
class EmployeeApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperEmployee
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperEmployee, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperEmployee';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperEmployee',
     ...
     *
     * @param  \Tripletex\Model\Employee $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperEmployee
     ...
     *
     * @param  \Tripletex\Model\Employee[] $body JSON representing a list of new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseEmployee
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseEmployee, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Tripletex\Model\ListResponseEmployee';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseEmployee',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\Employee $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperEmployee
     ...
     * @param  string $employee_number Containing (optional)
     * @param  bool $allow_information_registration Equals (optional)
     * @param  bool $include_contacts Equals (optional)
     ...
     * @return \Tripletex\Model\ListResponseEmployee
     */
    public function search($id = null, $first_name = null, $last_name = null, $employee_number = null, $allow_information_registration = null, $include_contacts = null, $department_id = null, $only_project_managers = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $first_name, $last_name, $employee_number, $allow_information_registration, $include_contacts, $department_id, $only_project_managers, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Tripletex\Model\ListResponseEmployee, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $first_name = null, $last_name = null, $employee_number = null, $allow_information_registration = null, $include_contacts = null, $department_id = null, $only_project_managers = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseEmployee';
        $request = $this->searchRequest($id, $first_name, $last_name, $employee_number, $allow_information_registration, $include_contacts, $department_id, $only_project_managers, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $first_name = null, $last_name = null, $employee_number = null, $allow_information_registration = null, $include_contacts = null, $department_id = null, $only_project_managers = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $first_name, $last_name, $employee_number, $allow_information_registration, $include_contacts, $department_id, $only_project_managers, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $first_name = null, $last_name = null, $employee_number = null, $allow_information_registration = null, $include_contacts = null, $department_id = null, $only_project_managers = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseEmployee';
        $request = $this->searchRequest($id, $first_name, $last_name, $employee_number, $allow_information_registration, $include_contacts, $department_id, $only_project_managers, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $first_name = null, $last_name = null, $employee_number = null, $allow_information_registration = null, $include_contacts = null, $department_id = null, $only_project_managers = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($employee_number !== null) {
            $queryParams['employeeNumber'] = ObjectSerializer::toQueryValue($employee_number);
        }
        // query params
        if ($allow_information_registration !== null) {
            $queryParams['allowInformationRegistration'] = ObjectSerializer::toQueryValue($allow_information_registration);
        }
        // query params
        if ($include_contacts !== null) {
            $queryParams['includeContacts'] = ObjectSerializer::toQueryValue($include_contacts);
        }
        // query params
        ...
        if ($only_project_managers !== null) {
            $queryParams['onlyProjectManagers'] = ObjectSerializer::toQueryValue($only_project_managers);
        }
        // query params
        if ($from !== null) {
