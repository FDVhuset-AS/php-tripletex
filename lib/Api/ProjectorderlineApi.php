...
class ProjectorderlineApi
{
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperProjectOrderLine
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperProjectOrderLine, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperProjectOrderLine';
     ...
     *
     * @param  \Tripletex\Model\ProjectOrderLine $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperProjectOrderLine
     ...
     *
     * @param  \Tripletex\Model\ProjectOrderLine[] $body JSON representing a list of new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseProjectOrderLine
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseProjectOrderLine, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Tripletex\Model\ListResponseProjectOrderLine';
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\ProjectOrderLine $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperProjectOrderLine
     ...
     * @return \Tripletex\Model\ListResponseProjectOrderLine
     */
    public function search($project_id, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return array of \Tripletex\Model\ListResponseProjectOrderLine, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($project_id, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseProjectOrderLine';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($project_id, $from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($project_id, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseProjectOrderLine';
        $request = $this->searchRequest($project_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($project_id, $from = null, $count = null, $sorting = null, $fields = null)
    {
