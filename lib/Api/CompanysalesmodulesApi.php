...
class CompanysalesmodulesApi
{
     ...
     * @return \Tripletex\Model\ListResponseSalesModuleDTO
     */
    public function get($from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseSalesModuleDTO, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseSalesModuleDTO';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseSalesModuleDTO',
     ...
     */
    public function getAsync($from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAsyncWithHttpInfo($from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseSalesModuleDTO';
        $request = $this->getRequest($from, $count, $sorting, $fields);
     ...
     */
    protected function getRequest($from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     *
     * @param  \Tripletex\Model\SalesModuleDTO $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperSalesModuleDTO
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperSalesModuleDTO, HTTP status code, HTTP response headers (array of strings)
     */
    public function postWithHttpInfo($body = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperSalesModuleDTO';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperSalesModuleDTO',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
