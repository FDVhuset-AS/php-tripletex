...
class CompanyApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperCompany
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperCompany, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperCompany';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperCompany',
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ListResponseCompany
     */
    public function getDivisions($from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponseCompany, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDivisionsWithHttpInfo($from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseCompany';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponseCompany',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDivisionsAsync($from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDivisionsAsyncWithHttpInfo($from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseCompany';
        $request = $this->getDivisionsRequest($from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getDivisionsRequest($from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \Tripletex\Model\ListResponseCompany
     */
    public function getWithLoginAccess($from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return array of \Tripletex\Model\ListResponseCompany, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithLoginAccessWithHttpInfo($from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseCompany';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWithLoginAccessAsync($from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWithLoginAccessAsyncWithHttpInfo($from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseCompany';
        $request = $this->getWithLoginAccessRequest($from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getWithLoginAccessRequest($from = null, $count = null, $sorting = null, $fields = null)
    {
     ...
     *
     * @param  \Tripletex\Model\Company $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperCompany
