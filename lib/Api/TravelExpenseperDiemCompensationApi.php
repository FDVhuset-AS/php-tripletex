...
class TravelExpenseperDiemCompensationApi
{
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperPerDiemCompensation
     */
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ResponseWrapperPerDiemCompensation, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperPerDiemCompensation';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ResponseWrapperPerDiemCompensation',
     ...
     *
     * @param  \Tripletex\Model\PerDiemCompensation $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperPerDiemCompensation
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Tripletex\Model\PerDiemCompensation $body Partial object describing what should be updated (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperPerDiemCompensation
     ...
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripletex\Model\ListResponsePerDiemCompensation, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $overnight_accommodation = null, $count_from = null, $count_to = null, $rate_from = null, $rate_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $is_deduction_for_breakfast = null, $is_lunch_deduction = null, $is_dinner_deduction = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponsePerDiemCompensation';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripletex\Model\ListResponsePerDiemCompensation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function searchRequest($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $overnight_accommodation = null, $count_from = null, $count_to = null, $rate_from = null, $rate_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $is_deduction_for_breakfast = null, $is_lunch_deduction = null, $is_dinner_deduction = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        ...
        if ($overnight_accommodation !== null) {
            $queryParams['overnightAccommodation'] = ObjectSerializer::toQueryValue($overnight_accommodation);
        }
        // query params
        if ($count_from !== null) {
        ...
        if ($is_deduction_for_breakfast !== null) {
            $queryParams['isDeductionForBreakfast'] = ObjectSerializer::toQueryValue($is_deduction_for_breakfast);
        }
        // query params
        if ($is_lunch_deduction !== null) {
            $queryParams['isLunchDeduction'] = ObjectSerializer::toQueryValue($is_lunch_deduction);
        }
        // query params
        if ($is_dinner_deduction !== null) {
            $queryParams['isDinnerDeduction'] = ObjectSerializer::toQueryValue($is_dinner_deduction);
        }
        // query params
        if ($from !== null) {
